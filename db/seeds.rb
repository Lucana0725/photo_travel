...
users = User.create!(
  [
    ...
    {id: 3, email: "ai@example.com", password: "hogehoge", last_name: "佛淵", first_name: "愛", last_name_kana: "ホトケブチ", first_name_kana: "アイ", nickname: "佛淵 愛", introduction: "Fiat500乗ってます！\r\nよろしくお願いします😊", is_deleted: false, profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/user_3.jpg"), filename: "user_3.jpg")},
    {id: 4, email: "sou@example.com", password: "hogehoge", last_name: "塚本", first_name: "颯", last_name_kana: "ツカモト", first_name_kana: "ソウ", nickname: "塚本 颯", introduction: "新型ノア、ようやく納車されました！！！", is_deleted: false, profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/user_4.jpg"), filename: "user_4.jpg")},
    {id: 5, email: "momoka@example.com", password: "hogehoge", last_name: "桑野", first_name: "萌々香", last_name_kana: "クワノ", first_name_kana: "モモカ", nickname: "桑野 萌々香", introduction: "愛車のクーパーでいろんなとこ出掛けて行きます🚗", is_deleted: false, profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/user_5.jpg"), filename: "user_5.jpg")},
    {id: 6, email: "tatsuya@example.com", password: "hogehoge", last_name: "若槻", first_name: "達也", last_name_kana: "ワカツキ", first_name_kana: "タツヤ", nickname: "ツッキー", introduction: "ゲストユーザーです。", is_deleted: false, profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/user_6.jpg"), filename: "user_6.jpg")}
  ]
)
...
travels = Travel.create!(
  [
    ...
    {title: "静かな街の一角", body: "買い物帰りに立ち寄った静かな街の一角です。駐車スペースで休憩中に撮りました！", address: nil, latitude: 34.690304998494625, longitude: 135.5014868364643, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/travel_3.jpg"), filename: "travel_3.jpg"), user_id: 3},
    {title: "都会の真ん中にて", body: "納車後長距離ドライブと称して友達に会いに東京まで！新しい車は都会に映えます😎", address: nil, latitude: 35.74659502832082, longitude: 139.64694358942845, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/travel_4.jpg"), filename: "travel_4.jpg"), user_id: 4},
...
Comment.create!(
  [
    ...
    {comment_body: "海沿いいいなー！", travel_id: 1, user_id: 3},
    {comment_body: "スポーツカーって感じ！", travel_id: 1, user_id: 1},
    {comment_body: "テストの\r\n改行\r\nメッセージ", travel_id: 1, user_id: 1},
  ]
)